...
public:
	...
	bool IsFirstEntry() const { return entry_counter == 1; }
...
private:
	...
	void LogWarning(const int line_number,
...
public:
	...
	bool IsFileOk() const { return !out_file.bad(); }
	...
	bool WriteDosBoxMetadata(const std::string& key,
